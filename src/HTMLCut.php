...
class HTMLCut
{
    ...
    public function Cut(\DOMNode|string $string, int $length, int $paragraphs = 0, string $ellipsis = '…', bool $stripUnwated = true): \DOMNode|string
    {
        #Sanitize length
        if ($length < 0) {
            $length = 0;
